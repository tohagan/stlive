...
module.exports = function(options, args) {
    ...
    if (options.author) {
        if (options.author.name)  shell.sed('-i', /PhoneGap Team/, options.author.name, 'config.xml');
        if (options.author.email) shell.sed('-i', /email="[^"]*"/, 'email="' + options.author.name + '"', 'config.xml');
        if (options.author.web)   shell.sed('-i', /author href="[^"]*"/, 'author href="' + options.author.web + '"', 'config.xml');
    }
