...
module.exports = {    
    ...
    help: function(options) {
        ...
        console.log(appName + ' create [domain] [AppName] - Creates and compiles a new Sencha Touch / PhoneGap 3.x app with "live edit" client.');
        console.log(appName + ' add      - Add "live edit" client to existing Sencha Touch or PhoneGap project.');
        console.log(appName + ' remove   - Removes "live edit" client from a Sencha Touch or PhoneGap project.');
